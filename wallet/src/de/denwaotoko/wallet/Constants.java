...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "fedoracoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

	public static final String BLOCKCHAIN_FILENAME = "blockchain" + FILENAME_NETWORK_SUFFIX;

	public static final String CHECKPOINTS_FILENAME = "checkpoints" + FILENAME_NETWORK_SUFFIX;

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://fedoracha.in";
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-tipstx";

	public static final int MAX_NUM_CONFIRMATIONS = 3;
	public static final String USER_AGENT = "Fedoracoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "TIPS";
	public static final String CURRENCY_CODE_MBTC = "KTIPS";
	...
	public static final String DONATION_ADDRESS = "EXHRAgVFyZjbjpaDiQ7tZUjfA5rgquBhEV";
	public static final String REPORT_EMAIL = "denwa@cock.li";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/denwaotoko/fedoracoin-wallet-new";
	public static final String BINARY_URL = ""; //TODO
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/denwaotoko/fedoracoinj-new";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = "http://fedoracoin.com/";
