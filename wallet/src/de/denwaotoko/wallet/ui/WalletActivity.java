...
import de.denwaotoko.wallet.ui.InputParser.BinaryInputParser;
import de.denwaotoko.wallet.ui.InputParser.StringInputParser;
import de.denwaotoko.wallet.util.CrashReporter;
import de.denwaotoko.wallet.util.Crypto;
import de.denwaotoko.wallet.util.HttpGetThread;
import de.denwaotoko.wallet.util.Iso8601Format;
...
/*		if (pm.resolveActivity(binaryIntent, 0) != null)
	...
	private void mailPrivateKeys(@Nonnull final File file)
	{
		...
		intent.setType("x-fedoracoin/private-keys");
