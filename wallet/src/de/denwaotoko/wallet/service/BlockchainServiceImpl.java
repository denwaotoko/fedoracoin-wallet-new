...
package de.denwaotoko.wallet.service;
...
import com.google.fedoracoin.net.discovery.*;
...
import com.google.fedoracoin.core.BlockChain;
import com.google.fedoracoin.core.CheckpointManager;
import com.google.fedoracoin.core.Peer;
import com.google.fedoracoin.core.PeerEventListener;
import com.google.fedoracoin.core.PeerGroup;
import com.google.fedoracoin.core.ScriptException;
...
import de.denwaotoko.wallet.AddressBookProvider;
import de.denwaotoko.wallet.Constants;
import de.denwaotoko.wallet.WalletApplication;
import de.denwaotoko.wallet.WalletBalanceWidgetProvider;
import de.denwaotoko.wallet.ui.WalletActivity;
import de.denwaotoko.wallet.util.CrashReporter;
import de.denwaotoko.wallet.util.GenericUtils;
import de.denwaotoko.wallet.util.ThrottlingWalletChangeListener;
import de.denwaotoko.wallet.util.WalletUtils;
import de.denwaotoko.wallet.R;
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				peerGroup.addPeerDiscovery(new PeerDiscovery()
				{
                    ...
                    String channel = "#fedoracoin" + String.format("%02d", i);
